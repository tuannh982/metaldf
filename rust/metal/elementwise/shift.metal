...
SHIFT_KERNEL(int8, char, 0)
SHIFT_KERNEL(int16, short, 0)
SHIFT_KERNEL(uint8, uchar, 0)
SHIFT_KERNEL(uint16, ushort, 0)
SHIFT_KERNEL(uint32, uint, 0)
SHIFT_KERNEL(uint64, ulong, 0L)
