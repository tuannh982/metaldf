...
INSTANTIATE_GATHER(char,   int8)
INSTANTIATE_GATHER(short,  int16)
INSTANTIATE_GATHER(uchar,  uint8)
INSTANTIATE_GATHER(ushort, uint16)
INSTANTIATE_GATHER(uint,   uint32)
INSTANTIATE_GATHER(ulong,  uint64)
