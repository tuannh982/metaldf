...
INSTANTIATE_BITONIC(char,   int8)
INSTANTIATE_BITONIC(short,  int16)
INSTANTIATE_BITONIC(uchar,  uint8)
INSTANTIATE_BITONIC(ushort, uint16)
INSTANTIATE_BITONIC(uint,   uint32)
INSTANTIATE_BITONIC(ulong,  uint64)

INSTANTIATE_BITONIC_LOCAL(float, float32)
INSTANTIATE_BITONIC_LOCAL(int,   int32)
INSTANTIATE_BITONIC_LOCAL(long,  int64)
INSTANTIATE_BITONIC_LOCAL(char,   int8)
INSTANTIATE_BITONIC_LOCAL(short,  int16)
INSTANTIATE_BITONIC_LOCAL(uchar,  uint8)
INSTANTIATE_BITONIC_LOCAL(ushort, uint16)
INSTANTIATE_BITONIC_LOCAL(uint,   uint32)
INSTANTIATE_BITONIC_LOCAL(ulong,  uint64)
