...
INSTANTIATE_SCAN_OP(char,   SumOp, sum_int8)
INSTANTIATE_SCAN_OP(short,  SumOp, sum_int16)
INSTANTIATE_SCAN_OP(uchar,  SumOp, sum_uint8)
INSTANTIATE_SCAN_OP(ushort, SumOp, sum_uint16)
INSTANTIATE_SCAN_OP(ulong,  SumOp, sum_uint64)
...
INSTANTIATE_SCAN_OP(char,   MinOp, min_int8)
INSTANTIATE_SCAN_OP(short,  MinOp, min_int16)
INSTANTIATE_SCAN_OP(uchar,  MinOp, min_uint8)
INSTANTIATE_SCAN_OP(ushort, MinOp, min_uint16)
INSTANTIATE_SCAN_OP(uint,   MinOp, min_uint32)
INSTANTIATE_SCAN_OP(ulong,  MinOp, min_uint64)
...
INSTANTIATE_SCAN_OP(char,   MaxOp, max_int8)
INSTANTIATE_SCAN_OP(short,  MaxOp, max_int16)
INSTANTIATE_SCAN_OP(uchar,  MaxOp, max_uint8)
INSTANTIATE_SCAN_OP(ushort, MaxOp, max_uint16)
INSTANTIATE_SCAN_OP(uint,   MaxOp, max_uint32)
INSTANTIATE_SCAN_OP(ulong,  MaxOp, max_uint64)
