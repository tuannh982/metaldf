...
| :white_check_mark: | P4 | Public cumulative ops (cumsum, cummin, cummax) | Small | High | None |
...
| | ID | Proposal | Effort | Impact | Deps |
|-|----|----------|--------|--------|------|
| :white_check_mark: | P9 | fillna / ffill / bfill (f32 scalar fillna, f32 ffill/bfill) | Small | Medium | P1 helps |
| | P10 | drop_duplicates / value_counts | Small | Medium | None |
| :white_check_mark: | P11 | shift / diff / pct_change | Small | Medium | None |
